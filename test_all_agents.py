...
from fixed_test_system import TestExpandedSystem

class ComprehensiveAgentTester:
    """Comprehensive testing system for all agents"""
    
    def __init__(self):
        self.registrar = NewAgentRegistrar()
        self.test_system = TestExpandedSystem()
        self.test_results = {
            'specialized_agents': {},
            'super_agents': {},
            'new_agents': {},
    ...
    async def run_comprehensive_tests(self):
        ...
        logging.info("🧪 Starting comprehensive agent testing...")
        ...
        try:
            ...
            existing_tests = await self.test_system.run_all_tests()
            self.test_results['system_integration'] = existing_tests
            
            # Test new agents
            new_agent_tests = await self.registrar.test_new_agents()
            self.test_results['new_agents'] = new_agent_tests
            ...
            logging.info("✅ Comprehensive agent testing completed successfully!")
            return report
    ...
    async def _generate_comprehensive_report(self):
        ...
        report = {
            ...
            'new_agents': self.test_results['new_agents'],
